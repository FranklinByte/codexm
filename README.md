...
Codexs-compatible local Codex account switcher for personal use.

This version is intentionally boring. The core account behavior is based on the locally installed `@uninto/codexs@0.1.8` MIT package:
...
This project vendors/adapts MIT-licensed source from `@uninto/codexs@0.1.8` and keeps the risky parts out of codexm. Display text and the store filename are codexm-specific; account switching and usage probing follow the codexs model.